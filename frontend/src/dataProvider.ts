...
interface GetListParams {
  resource: Resource // Assuming resource is a string
  pagination: string // Replace 'any' with a more specific type if possible
  sorters: string // Replace 'any' with a more specific type if possible
  filters: string // Replace 'any' with a more specific type if possible
  meta: string // Replace 'any' with a more specific type if possible
}
